...
describe('AcademicSemester unit tests', () => {
    ...
    it('academicSemester notification should inform error day of ending Firstquarter is after begining secondQuarter', () => {
        ...
        expect(semester.notification.getErrors().length > 0).toBeTruthy();
        expect(semester.notification.getErrors()).toMatchObject([
            { context: 'academicSemester', message: "the end of the first Quarter must be before the start of the begining of the secondQuarter" },
        ]);
    });
